...
# create dummy users to populate database 
db.add_all([
...
#   User(username='idonthavearealemail', email='idonthavearealemail', password='password123')
])

db.commit()

# create dummy posts to populate database
db.add_all([
...
# create dummy comments to populate database
db.add_all([
...
# create dummy votes to populate database
db.add_all([
